...
namespace corkpp {
   REAL incircleadapt(vertex pa, vertex pb, vertex pc, vertex pd,
                      REAL permanent);
  ...
  double dstore(double x) { return (x); }
  ...
  REAL orient3dadapt(REAL * pa, REAL * pb, REAL * pc, REAL * pd,
                     REAL permanent) {
  ...
  REAL orient3d(REAL * pa, REAL * pb, REAL * pc, REAL * pd) {
    return (REAL)-cgal_pred_obj.orientation_3_object()(
        Point(pa[0], pa[1], pa[2]), Point(pb[0], pb[1], pb[2]),
        Point(pc[0], pc[1], pc[2]), Point(pd[0], pd[1], pd[2]));
  }
  ...
  /*               it lies outside; and zero if the four points are
   * cocircular.*/
  ...
  //   cytabt[16]; int axtbctlen, aytbctlen, bxtcatlen, bytcatlen, cxtabtlen,
  //   cytabtlen; REAL axtbctt[8], aytbctt[8], bxtcatt[8]; REAL bytcatt[8],
  //   cxtabtt[8], cytabtt[8]; int axtbcttlen, aytbcttlen, bxtcattlen,
  //   bytcattlen, cxtabttlen, cytabttlen; REAL abt[8], bct[8], cat[8]; int
  //   abtlen, bctlen, catlen; REAL abtt[4], bctt[4], catt[4]; int abttlen,
  //   bcttlen, cattlen; INEXACT REAL abtt3, bctt3, catt3; REAL negate;
  ...
  //   bc[0]); bc[3] = bc3; axbclen = scale_expansion_zeroelim(4, bc, adx,
  //   axbc); axxbclen = scale_expansion_zeroelim(axbclen, axbc, adx, axxbc);
  ...
  //   ca[0]); ca[3] = ca3; bxcalen = scale_expansion_zeroelim(4, ca, bdx,
  //   bxca); bxxcalen = scale_expansion_zeroelim(bxcalen, bxca, bdx, bxxca);
  ...
  //   ab[0]); ab[3] = ab3; cxablen = scale_expansion_zeroelim(4, ab, cdx,
  //   cxab); cxxablen = scale_expansion_zeroelim(cxablen, cxab, cdx, cxxab);
  ...
  //                                      - (bdy * cdxtail + cdx * bdytail))
  //           + 2.0 * (adx * adxtail + ady * adytail) * (bdx * cdy - bdy *
  //           cdx))
  //        + ((bdx * bdx + bdy * bdy) * ((cdx * adytail + ady * cdxtail)
  //                                      - (cdy * adxtail + adx * cdytail))
  //           + 2.0 * (bdx * bdxtail + bdy * bdytail) * (cdx * ady - cdy *
  //           adx))
  //        + ((cdx * cdx + cdy * cdy) * ((adx * bdytail + bdy * adxtail)
  //                                      - (ady * bdxtail + bdx * adytail))
  //           + 2.0 * (cdx * cdxtail + cdy * cdytail) * (adx * bdy - ady *
  //           bdx));
  //   if ((det >= errbound) || (-det >= errbound)) {
  //     return det;
  //   }
  ...
  //       temp16a); axtbctlen = scale_expansion_zeroelim(bctlen, bct, adxtail,
  //       axtbct); temp32alen = scale_expansion_zeroelim(axtbctlen, axtbct, 2.0
  //       * adx,
  //                                             temp32a);
  ...
  //       axtbctt); temp16alen = scale_expansion_zeroelim(axtbcttlen,
  //       axtbctt, 2.0 * adx,
  //                                             temp16a);
  ...
  //       temp16a); aytbctlen = scale_expansion_zeroelim(bctlen, bct, adytail,
  //       aytbct); temp32alen = scale_expansion_zeroelim(aytbctlen, aytbct, 2.0
  //       * ady,
  //                                             temp32a);
  //       temp48len = fast_expansion_sum_zeroelim(temp16alen, temp16a,
  //                                               temp32alen, temp32a, temp48);
  ...
  //       aytbctt); temp16alen = scale_expansion_zeroelim(aytbcttlen,
  //       aytbctt, 2.0 * ady,
  //                                             temp16a);
  ...
  //       temp16a); bxtcatlen = scale_expansion_zeroelim(catlen, cat, bdxtail,
  //       bxtcat); temp32alen = scale_expansion_zeroelim(bxtcatlen, bxtcat, 2.0
  //       * bdx,
  //                                             temp32a);
  //       temp48len = fast_expansion_sum_zeroelim(temp16alen, temp16a,
  //                                               temp32alen, temp32a, temp48);
  ...
  //       bxtcatt); temp16alen = scale_expansion_zeroelim(bxtcattlen,
  //       bxtcatt, 2.0 * bdx,
  //                                             temp16a);
  ...
  //       temp16a); bytcatlen = scale_expansion_zeroelim(catlen, cat, bdytail,
  //       bytcat); temp32alen = scale_expansion_zeroelim(bytcatlen, bytcat, 2.0
  //       * bdy,
  //                                             temp32a);
  //       temp48len = fast_expansion_sum_zeroelim(temp16alen, temp16a,
  //                                               temp32alen, temp32a, temp48);
  ...
  //       bytcatt); temp16alen = scale_expansion_zeroelim(bytcattlen,
  //       bytcatt, 2.0 * bdy,
  //                                             temp16a);
  ...
  //       temp16a); cxtabtlen = scale_expansion_zeroelim(abtlen, abt, cdxtail,
  //       cxtabt); temp32alen = scale_expansion_zeroelim(cxtabtlen, cxtabt, 2.0
  //       * cdx,
  //                                             temp32a);
  //       temp48len = fast_expansion_sum_zeroelim(temp16alen, temp16a,
  //                                               temp32alen, temp32a, temp48);
  ...
  //       temp16a); cytabtlen = scale_expansion_zeroelim(abtlen, abt, cdytail,
  //       cytabt); temp32alen = scale_expansion_zeroelim(cytabtlen, cytabt, 2.0
  //       * cdy,
  //                                             temp32a);
  //       temp48len = fast_expansion_sum_zeroelim(temp16alen, temp16a,
  //                                               temp32alen, temp32a, temp48);
  ...
  //       cytabtt); temp16alen = scale_expansion_zeroelim(cytabttlen,
  //       cytabtt, 2.0 * cdy,
  //                                             temp16a);
  ...
  REAL orient4dadapt(REAL * pa, REAL * pb, REAL * pc, REAL * pd, REAL * pe,
    ...
    return orient4dexact(pa, pb, pc, pd, pe, aheight, bheight, cheight, dheight,
                         eheight);
  }
  ...
  REAL orient4d(REAL * pa, REAL * pb, REAL * pc, REAL * pd, REAL * pe,
    ...
    return orient4dadapt(pa, pb, pc, pd, pe, aheight, bheight, cheight, dheight,
                         eheight, permanent);
  }
