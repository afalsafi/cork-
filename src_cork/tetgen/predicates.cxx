...
//   cxtabtt[8], cytabtt[8]; int axtbcttlen, aytbcttlen, bxtcattlen, bytcattlen,
//   cxtabttlen, cytabttlen; REAL abt[8], bct[8], cat[8]; int abtlen, bctlen,
//   catlen; REAL abtt[4], bctt[4], catt[4]; int abttlen, bcttlen, cattlen;
...
REAL orient4d(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL *pe, REAL aheight,
              REAL bheight, REAL cheight, REAL dheight, REAL eheight) {
  REAL aex, bex, cex, dex;
  REAL aey, bey, cey, dey;
  REAL aez, bez, cez, dez;
  REAL aexbey, bexaey, bexcey, cexbey, cexdey, dexcey, dexaey, aexdey;
