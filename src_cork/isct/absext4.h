...
namespace corkpp {
  namespace AbsExt4 {
    ...
    inline void neg(AbsExt4_1 & out, const AbsExt4_1 & in) { out = in; }
    inline void neg(AbsExt4_2 & out, const AbsExt4_2 & in) { out = in; }
    inline void neg(AbsExt4_3 & out, const AbsExt4_3 & in) { out = in; }
    ...
    inline void join(AbsExt4_2 & out, const AbsExt4_1 & lhs,
                     const AbsExt4_1 & rhs) {
    ...
    inline void join(AbsExt4_3 & out, const AbsExt4_2 & lhs,
                     const AbsExt4_1 & rhs) {
    ...
    inline void join(AbsExt4_3 & out, const AbsExt4_1 & lhs,
                     const AbsExt4_2 & rhs) {
      join(out, rhs, lhs);
    }
    ...
    inline void meet(AbsExt4_2 & out, const AbsExt4_3 & lhs,
                     const AbsExt4_3 & rhs) {
      AbsExt4_2 out_dual;
      AbsExt4_1 lhs_dual;
      AbsExt4_1 rhs_dual;
    ...
    inline void meet(AbsExt4_1 & out, const AbsExt4_2 & lhs,
                     const AbsExt4_3 & rhs) {
      AbsExt4_3 out_dual;
      AbsExt4_2 lhs_dual;
      AbsExt4_1 rhs_dual;
    ...
    inline void meet(AbsExt4_1 & out, const AbsExt4_3 & lhs,
                     const AbsExt4_2 & rhs) {
      AbsExt4_3 out_dual;
      AbsExt4_1 lhs_dual;
      AbsExt4_2 rhs_dual;
