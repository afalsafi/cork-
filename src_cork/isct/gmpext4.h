...
namespace corkpp {
  namespace GMPExt4 {
    ...
    inline std::ostream & operator<<(std::ostream & out,
                                     const GmpExt4_1 & ext) {
      return out << '[' << ext.e0 << ',' << ext.e1 << ',' << ext.e2 << ','
                 << ext.e3 << ']';
    }
    inline std::ostream & operator<<(std::ostream & out,
                                     const GmpExt4_2 & ext) {
      return out << '[' << ext.e01 << ',' << ext.e02 << ',' << ext.e03 << ','
                 << ext.e12 << ',' << ext.e13 << ',' << ext.e23 << ']';
    }
    inline std::ostream & operator<<(std::ostream & out,
                                     const GmpExt4_3 & ext) {
      return out << '[' << ext.e012 << ',' << ext.e013 << ',' << ext.e023 << ','
                 << ext.e123 << ']';
    }
    ...
    inline void join(GmpExt4_2 & out, const GmpExt4_1 & lhs,
                     const GmpExt4_1 & rhs) {
    ...
    inline void join(GmpExt4_3 & out, const GmpExt4_2 & lhs,
                     const GmpExt4_1 & rhs) {
    ...
    inline void join(GmpExt4_3 & out, const GmpExt4_1 & lhs,
                     const GmpExt4_2 & rhs) {
      join(out, rhs, lhs);
    ...
    inline void meet(GmpExt4_2 & out, const GmpExt4_3 & lhs,
                     const GmpExt4_3 & rhs) {
      GmpExt4_2 out_dual;
      GmpExt4_1 lhs_dual;
      GmpExt4_1 rhs_dual;
    ...
    inline void meet(GmpExt4_1 & out, const GmpExt4_2 & lhs,
                     const GmpExt4_3 & rhs) {
      GmpExt4_3 out_dual;
      GmpExt4_2 lhs_dual;
      GmpExt4_1 rhs_dual;
    ...
    inline void meet(GmpExt4_1 & out, const GmpExt4_3 & lhs,
                     const GmpExt4_2 & rhs) {
      GmpExt4_3 out_dual;
      GmpExt4_1 lhs_dual;
      GmpExt4_2 rhs_dual;
    ...
    inline mpz_class inner(const GmpExt4_2 & lhs, const GmpExt4_2 & rhs) {
      return lhs.e01 * rhs.e01 + lhs.e02 * rhs.e02 + lhs.e03 * rhs.e03 +
             lhs.e12 * rhs.e12 + lhs.e13 * rhs.e13 + lhs.e23 * rhs.e23;
    }
    inline mpz_class inner(const GmpExt4_3 & lhs, const GmpExt4_3 & rhs) {
      return lhs.e012 * rhs.e012 + lhs.e013 * rhs.e013 + lhs.e023 * rhs.e023 +
             lhs.e123 * rhs.e123;
    }
