...
#define DLLEXPORT
  ...
  // result = A U B
  DLLEXPORT void computeUnion(CorkTriMesh in0, CorkTriMesh in1,
                              CorkTriMesh * out);

  // result = A - B
  DLLEXPORT void computeDifference(CorkTriMesh in0, CorkTriMesh in1,
                                   CorkTriMesh * out);

  // result = A ^ B
  DLLEXPORT void computeIntersection(CorkTriMesh in0, CorkTriMesh in1,
                                     CorkTriMesh * out);

  // result = A XOR B
  DLLEXPORT void computeSymmetricDifference(CorkTriMesh in0, CorkTriMesh in1,
                                            CorkTriMesh * out);
  ...
  DLLEXPORT void resolveIntersections(CorkTriMesh in0, CorkTriMesh in1,
                                      CorkTriMesh * out);
